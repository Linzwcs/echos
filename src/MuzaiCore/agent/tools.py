        ...
        for service_name, service in self._facade._services.items():
            ...
            for method_name, method in inspect.getmembers(
                ...
                if hasattr(method, '_tool_metadata'):
                    ...
                    tool = Tool(name=f"{service_name}_{method_name}",
    ...
    def _create_tool_wrapper(self, service_name: str, method_name: str,
        ...
        def wrapper(**kwargs) -> ToolResponse:
            try:
                ...
                self._log_execution(f"{service_name}_{method_name}", kwargs)
                result = self._facade.execute_tool(service_name, method_name,
                                                   **kwargs)
