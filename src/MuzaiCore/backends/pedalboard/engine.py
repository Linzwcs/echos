...
from .messages import BaseMessage, NonRealTimeMessage, RealTimeMessage
...
class PedalboardEngine(IEngine):
    ...
    def _process_rt_messages(self):
        self._rt_message_queue.drain(
            lambda msg: process_message(msg, self._render_graph))

    def _process_nrt_messages(self):
        self._nrt_message_queue.drain(
            lambda msg: process_message(msg, self._render_graph))
